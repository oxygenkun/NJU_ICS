...
def_EHelper(srli) { rtl_srli(s, ddest, dsrc1, id_src2->imm & 0b111111u); }

def_EHelper(srai) { rtl_srai(s, ddest, dsrc1, id_src2->imm & 0b111111u); }
...
def_EHelper(mulhsu) { rtl_mulsu_hi(s, ddest, dsrc1, dsrc2); }

def_EHelper(div) { rtl_divs_q(s, ddest, dsrc1, dsrc2); }

def_EHelper(divu) { rtl_divu_q(s, ddest, dsrc1, dsrc2); }

def_EHelper(rem) { rtl_divs_r(s, ddest, dsrc1, dsrc2); }

def_EHelper(remu) { rtl_divu_r(s, ddest, dsrc1, dsrc2); }